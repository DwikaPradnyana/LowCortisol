...
export default function Button({
  ...
  // Gaya dasar yang selalu ada di setiap tombol
  ...
  // Pemetaan varian warna (sesuai index.css LowCortisol)
  const variants = {
  ...
  // Jika ada prop 'to', render sebagai React Router Link
  if (to) {
    return (
  ...
  // Default: render sebagai button standar
  return (
